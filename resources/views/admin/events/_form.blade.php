...
<div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
    ...
    @if ($event->template)
        <div>
            ...
            <div class="mt-1 flex items-center gap-2 text-sm">
                <span class="inline-block w-3 h-3 rounded-sm" style="background-color: {{ $event->template->color }}"></span>
    ...
    <div class="sm:col-span-2">
        ...
        <textarea name="description" id="description" rows="4"
                  class="mt-1 block w-full border-gray-300 dark:border-gray-600 focus:border-fct-cyan focus:ring-fct-cyan rounded-md shadow-xs">{{ old('description', $event->description) }}</textarea>
    </div>
