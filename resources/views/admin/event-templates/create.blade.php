<x-layouts.admin :title="'New event template · Admin'">
    ...
    <div class="mb-6 max-w-2xl">
        <h1 class="text-2xl font-semibold text-gray-900">New event template</h1>
        <p class="text-sm text-gray-500 mt-1">Create the template first, then add default positions and reminders on the next screen.</p>
    </div>
