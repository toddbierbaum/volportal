<x-layouts.admin :title="'Add admin · Admin'">
    ...
    <form method="POST" action="{{ route('admin.admins.store') }}"
        ...
        <div class="mt-6 pt-4 border-t border-gray-100 dark:border-gray-700/60 flex items-center justify-end gap-3">
            <a href="{{ route('admin.admins.index') }}" class="px-4 py-2 text-sm text-gray-600 dark:text-gray-400 dark:text-gray-500 hover:text-gray-900 dark:text-gray-100">Cancel</a>
