<x-layouts.admin-auth title="Set Up Two-Factor Authentication">
    ...
    {{-- QR SVG ships with black modules on transparent/white background; wrap in a white pad
         so the quiet-zone stays scannable regardless of the surrounding card colour. --}}
